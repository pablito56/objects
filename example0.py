#-*- coding: utf-8 -*-
u'''
OBJECTS EXAMPLE 0: Everything is an object
'''
...
# - Immutable types values are reused by the compiler (so their id is the same): int, float, string, tuple
...
# Multiple assignment with lists (mutable)
x = y = []
print x, '@', id(x)
print y, '@', id(y)
